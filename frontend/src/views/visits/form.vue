            ...
            <el-form-item label="客户" prop="customerId">
              ...
              >
                <el-option
                    ...
                    :key="customer.id"
                    :label="`${customer.name} (${customer.schoolName} - ${customer.departmentName})`"
                    :value="customer.id"
                />
              </el-select>
            </el-form-item>
...
const handleCustomerFocus = () => {
  // 如果没有选项且没有正在加载，可以加载默认客户列表
  if (customerOptions.value.length === 0 && !customerLoading.value) {
    searchCustomers('')
  }
}
